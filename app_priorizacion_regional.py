...
def load_data() -> pd.DataFrame:
    """Carga la base precargada. En despliegue prioriza el CSV comprimido (.gz)."""
    data_file = DATA_FILE_GZ if DATA_FILE_GZ.exists() else DATA_FILE_CSV
    if not data_file.exists():
        raise FileNotFoundError(
            "No se encontró data/locales_priorizacion.csv.gz ni data/locales_priorizacion.csv"
        )
